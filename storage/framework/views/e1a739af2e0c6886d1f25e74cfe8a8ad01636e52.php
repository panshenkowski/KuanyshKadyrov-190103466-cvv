        ...
        <header class="header">
            <div class="header__container">
                <a href="/" class="header__logo-container" style="margin-left: 10px">
                    <span class="header__logo" href="/"><?php echo app('translator')->get('main.2'); ?></span>
                </a>
                <nav class="header__nav" >
                    <a class="header__link" href="/more" style="margin-left: 400px">
                        <?php echo app('translator')->get('main.feedback'); ?>
                    </a>
                </nav>
                <nav class="header__nav">
                    <a class="header__link" href="<?php echo e(route('locale' ,$cur1)); ?>" style="margin-right: 10px">
                        <?php echo app('translator')->get('main.kz'); ?>
                    </a>
                </nav>
                <nav class="header__nav">
                    <a class="header__link" href="<?php echo e(route('locale' ,$cur2)); ?>" style="margin-right: 10px">
                        <?php echo app('translator')->get('main.ru'); ?>
                    </a>
                </nav>
            </div>
        </header>
        <div class="bg sport-cover">
            ...
            <div class="video__color-layer">
                <div class="video-title">
                    <h2 class="video-title__heading"><?php echo app('translator')->get('main.men'); ?></h2>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card border-0 mb-grid-gutter">
                        <a class="card-img-tiles" href="">
                            <div class="main-img"><img src="<?php echo e($image); ?>" alt="<?php echo e($product->title); ?>"></div>
                            <div class="thumblist">
                                <?php if($image == 'https://www.creativefabrica.com/wp-content/uploads/2019/03/Monogram-SH-Logo-Design-by-Greenlines-Studios-580x386.jpg'): ?>

                                <?php else: ?>
                                    <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($loop->first): ?>
                                            <img src="<?php echo e($img['img']); ?>" alt="<?php echo e($product->title); ?>">
                                        <?php else: ?>
                                            <img src="<?php echo e($img['img']); ?>" alt="<?php echo e($product->title); ?>">
                                        <?php endif; ?>
                        ...
                        <div class="card-body border mt-n1 py-4 text-center" style="border-radius: 15px;">
                            <h2 class="h5 mb-1"><?php echo e($product->title); ?></h2><span class="d-block mb-3 font-size-xs text-muted"> <span class="font-weight-semibold"><?php echo app('translator')->get('main.$'); ?><?php echo e($product->price); ?></span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.html"><?php echo app('translator')->get('main.buy'); ?></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/kadyrovkuanysh/Desktop/news_p/resources/views/products.blade.php ENDPATH**/ ?>