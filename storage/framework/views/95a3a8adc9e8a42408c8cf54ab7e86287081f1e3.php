...
<div class="root">
    <div class="cover">
        <a href="/clothes" class="main-link">
            <p class="cover__subtitle"><?php echo app('translator')->get('main.1'); ?></p>
            <p class="cover__title"><?php echo app('translator')->get('main.2'); ?></p>
        </a>
    </div>

    <p class="copyright copyright__white"><?php echo app('translator')->get('main.3'); ?>
        <a href="https://www.instagram.com/kadyrovkt/" target="_blank" rel="noopener noreferrer" class="kruzhok-link">
            <?php echo app('translator')->get('main.4'); ?>
        </a>
    </p>
</div>
...
<?php /**PATH /Users/kadyrovkuanysh/Desktop/new_project/resources/views/welcome.blade.php ENDPATH**/ ?>