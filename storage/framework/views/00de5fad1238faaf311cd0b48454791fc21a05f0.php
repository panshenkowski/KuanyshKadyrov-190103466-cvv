...
<section class="cards">
    <a class="card " href="">
        <p class="card__title"><?php echo app('translator')->get('main.women'); ?></p>
        <p class="card__text">
            <?php echo app('translator')->get('main.cotton'); ?>
        </p>
    ...
    <a class="card " href="/products">
        <p class="card__title"><?php echo app('translator')->get('main.men'); ?></p>
        <p class="card__text">
            <?php echo app('translator')->get('main.cotton'); ?>
        </p>
        <video autoplay="" loop="" muted="" class="card__bg-video" poster="#" style="top: 80%">
    ...
    <a class="card " href="">
        <p class="card__title"><?php echo app('translator')->get('main.kid'); ?></p>
        <p class="card__text">
            <?php echo app('translator')->get('main.cotton'); ?>
        </p>
        <video autoplay="" loop="" muted="" class="card__bg-video" poster="#" style="top: 80%">
...
<?php /**PATH /Users/kadyrovkuanysh/Desktop/new_project/resources/views/clothes.blade.php ENDPATH**/ ?>